...
@Injectable()
export class FindChallengesByProfessorUseCase {
  constructor(
    @Inject(CHALLENGE_REPOSITORY)
    private readonly challengeRepository: IChallengeRepository,
  ) {}

  async execute(professorId: string, query?: ListChallengesQueryDto) {
    ...
    return await this.challengeRepository.findByProfessor(professorId, skip, limit, visibilityFilter, false);
  }
}